...
|---|---|---|
| Qwen3.6-27B (NVFP4) text generation | Correctness-complete, at/above vLLM speed | Token-exact greedy on GB10; beats vLLM 0.25.0 tput at every concurrency (1.007-1.045x), parity 115/124 axes. FP8+ModelOpt NVFP4 load (#164) |
